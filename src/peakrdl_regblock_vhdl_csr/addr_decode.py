    ...
    def _add_addressablenode_decoding_flags(self, node: 'AddressableNode') -> None:
        ...
        if isinstance(node, MemNode):
            ...
            if readable and writable:
                ...
                rhs = f"{addr_decoding_str} and to_std_logic(cpuif_req_op = OP_READ)"
                rhs_invalid_rw = f"{addr_decoding_str} and to_std_logic(cpuif_req_op /= OP_READ)"
            elif not readable and writable:
                rhs = f"{addr_decoding_str} and to_std_logic(cpuif_req_op = OP_WRITE)"
                rhs_invalid_rw = f"{addr_decoding_str} and to_std_logic(cpuif_req_op /= OP_WRITE)"
            else:
                raise RuntimeError
        # Add decoding flags
